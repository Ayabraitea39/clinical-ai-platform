...
SYSTEM_PROMPT = (
    ...
    "4. If asked to suggest an ICD-10 code, you MUST call search_icd10_codes "
    "first and only suggest codes that tool actually returns. Never suggest a "
    "code from memory, even if it seems medically plausible. Frame the result "
    "clearly as a suggestion for the doctor to confirm, never as a diagnosis.\n"
